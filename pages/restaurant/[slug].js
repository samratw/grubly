    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="relative">
                <div className="h-48 w-full bg-gradient-to-r from-orange-400 to-orange-600"></div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center mt-2">
                                        <div className="flex items-center bg-orange-100 text-orange-700 px-2 py-1 rounded-full text-sm">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center mb-4">
                        <MdOutlineCategory className="text-orange-500 text-xl mr-2" />
                    ...
                    <div className="lg:col-span-2">
                        {Object.entries(groupedItems).map(([category, items]) => (
                            <div key={category} id={category} className="mb-12">
                                <h2 className="text-2xl font-bold text-gray-900 border-b-2 border-orange-500 pb-2 mb-6 inline-block">
                                    {category}
                                </h2>
                                            ...
                                            <div className="p-5">
                                                <div className="flex justify-between items-start">
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-lg font-bold text-orange-500 mt-2">Rs. {item.price}</p>
                                                    </div>
                                                    {item.image && (
                                                ...
                                                <div className="flex items-center justify-between mt-4">
                                                    <div className="flex items-center space-x-2">
                                                        <button
                                                            ...
                                                            className="w-8 h-8 rounded-full bg-orange-100 text-orange-500 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:bg-orange-200 transition-colors"
                                                        >
                                ...
                                <>
                                    ...
                                    <div className="border-t pt-4">
                                        <div className="flex justify-between items-center mb-4">
                                            ...
                                            <span className="text-xl font-bold text-orange-500">Rs. {cartTotal}</span>
                                        </div>
